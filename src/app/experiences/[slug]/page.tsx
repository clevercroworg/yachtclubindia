...
import { Anchor, Phone, MessageCircle, ArrowLeft } from 'lucide-react';
...
const galleryImages = [
    { src: '/images/yacht/leopard/leopard-1.jpg', alt: 'Yacht Experience 1' },
    { src: '/images/yacht/leopard/leopard-2.jpg', alt: 'Yacht Experience 2' },
    { src: '/images/yacht/leopard/leopard-3.jpg', alt: 'Yacht Experience 3' },
    { src: '/images/yacht/leopard/leopard-4.jpg', alt: 'Yacht Experience 4' },
    { src: '/images/yacht/leopard/leopard-5.jpg', alt: 'Yacht Experience 5' },
    { src: '/images/yacht/leopard/leopard-6.jpg', alt: 'Yacht Experience 6' },
];
        ...
        <main className="pt-24">
            <section className="occasion-page-hero relative overflow-hidden">
                ...
                <div className="relative mx-auto max-w-7xl px-6 py-24 sm:py-28 lg:py-36" data-reveal="true">
                    ...
                    <h1 className="experience-page-title">{experience.title}</h1>
            ...
            <section className="section-surface py-24">
                <div className="mx-auto max-w-7xl px-6" data-reveal="true">
                    ...
                    <p className="section-subtitle">A glimpse into what awaits you onboard.</p>
            ...
            <section className="bg-[#F4F7FB] py-24">
                <div className="mx-auto max-w-7xl px-6" data-reveal="true">
                    ...
                    <p className="section-subtitle">Watch real moments from our yacht charters.</p>
            ...
            <section className="contact-cta-section py-24">
                <div className="mx-auto max-w-4xl px-6 text-center" data-reveal="true">
                    ...
                    <p className="section-subtitle" style={{ color: 'rgba(255,255,255,0.7)' }}>Have questions or ready to plan your {experience.title.toLowerCase()}? Reach out to us directly.</p>
                ...
                <div className="luxe-cta-box" data-reveal="true">
                    <div className="luxe-cta-inner">
                        <div className="luxe-cta-copy">
                            ...
                            <h3 className="luxe-cta-title">Plan Your {experience.title}</h3>
                        </div>
