...
const galleryImages = [
    { src: '/images/yacht/leopard/leopard-7.jpg', alt: 'Private Event Cruises 1' },
    { src: '/images/yacht/leopard/leopard-8.jpg', alt: 'Private Event Cruises 2' },
    { src: '/images/yacht/leopard/leopard-9.jpg', alt: 'Private Event Cruises 3' },
    { src: '/images/yacht/leopard/leopard-10.jpg', alt: 'Private Event Cruises 4' },
    { src: '/images/yacht/leopard/leopard-11.jpg', alt: 'Private Event Cruises 5' },
    { src: '/images/yacht/leopard/leopard-12.jpg', alt: 'Private Event Cruises 6' },
];

export default function PrivateEventCruisesPage() {
    useEffect(() => {
    ...
    return (
        <main className="pt-24">
            <section className="occasion-page-hero relative overflow-hidden">
                <Image
                    src="/images/c8.jpg"
                    alt="Private Event Cruises in Goa"
                    fill
                    sizes="100vw"
                    priority
                ...
                <div className="relative mx-auto max-w-7xl px-6 py-24 sm:py-28 lg:py-36" data-reveal="true">
                    ...
                    <h1 className="experience-page-title">Private Event Cruises</h1>
                    <p className="experience-page-sub">
                        Host milestones, corporate retreats, and larger gatherings on our luxury fleet.
                    </p>
            ...
            <section className="section-surface py-24">
                <div className="mx-auto max-w-7xl px-6" data-reveal="true">
                    ...
                    <p className="section-subtitle">A glimpse into the unforgettable private events we&apos;ve hosted at sea.</p>
            ...
            <section className="bg-[#F4F7FB] py-24">
                <div className="mx-auto max-w-7xl px-6" data-reveal="true">
                    ...
                    <p className="section-subtitle">Watch real event moments captured on our yachts.</p>
            ...
            <section className="contact-cta-section py-24">
                <div className="mx-auto max-w-4xl px-6 text-center" data-reveal="true">
                    ...
                    <p className="section-subtitle" style={{ color: 'rgba(255,255,255,0.7)' }}>Have questions or ready to plan your private event cruise? Reach out to us directly.</p>
                ...
                <div className="luxe-cta-box" data-reveal="true">
                    <div className="luxe-cta-inner">
                        <div className="luxe-cta-copy">
                            <p className="luxe-cta-kicker">Event Concierge</p>
                            <h3 className="luxe-cta-title">Reserve Your Event Date</h3>
                        </div>
