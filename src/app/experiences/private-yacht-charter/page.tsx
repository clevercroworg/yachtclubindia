...
const galleryImages = [
    { src: '/images/yacht/amazonite/amzonite-1.jpg', alt: 'Private Charter 1' },
    { src: '/images/yacht/amazonite/amzonite-2.jpg', alt: 'Private Charter 2' },
    { src: '/images/yacht/amazonite/amzonite-3.jpg', alt: 'Private Charter 3' },
    { src: '/images/yacht/amazonite/amzonite-4.jpg', alt: 'Private Charter 4' },
    { src: '/images/yacht/amazonite/amzonite-5.jpg', alt: 'Private Charter 5' },
    { src: '/images/yacht/amazonite/amzonite-6.jpg', alt: 'Private Charter 6' },
];

export default function PrivateYachtCharterPage() {
    useEffect(() => {
    ...
    return (
        <main className="pt-24">
            <section className="occasion-page-hero relative overflow-hidden">
                <Image
                    src="/images/c1.jpg"
                    alt="Private yacht charter in Goa"
                    fill
                    sizes="100vw"
                    priority
                ...
                <div className="relative mx-auto max-w-7xl px-6 py-24 sm:py-28 lg:py-36" data-reveal="true">
                    ...
                    <h1 className="experience-page-title">Private Yacht Charter</h1>
                    <p className="experience-page-sub">
                        Exclusive yacht time tailored for your group, complete with premium service.
                    </p>
            ...
            <section className="section-surface py-24">
                <div className="mx-auto max-w-7xl px-6" data-reveal="true">
                    ...
                    <p className="section-subtitle">A glimpse into the unforgettable private charter moments we&apos;ve helped create at sea.</p>
            ...
            <section className="bg-[#F4F7FB] py-24">
                <div className="mx-auto max-w-7xl px-6" data-reveal="true">
                    ...
                    <p className="section-subtitle">Watch real charter moments captured on our yachts.</p>
            ...
            <section className="contact-cta-section py-24">
                <div className="mx-auto max-w-4xl px-6 text-center" data-reveal="true">
                    ...
                    <p className="section-subtitle" style={{ color: 'rgba(255,255,255,0.7)' }}>Have questions or ready to plan your private charter? Reach out to us directly.</p>
                ...
                <div className="luxe-cta-box" data-reveal="true">
                    <div className="luxe-cta-inner">
                        <div className="luxe-cta-copy">
                            <p className="luxe-cta-kicker">Experience Concierge</p>
                            <h3 className="luxe-cta-title">Reserve Your Yacht Charter</h3>
                        </div>
